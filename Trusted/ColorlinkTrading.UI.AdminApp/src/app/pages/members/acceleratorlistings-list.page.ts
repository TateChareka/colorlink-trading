...
@Component({
  selector: 'acceleratorlistings-list',
  templateUrl: './acceleratorlistings-list.page.html',
  styleUrls: ['./../../../theme/datagrid-toolbar.css']
})

export class AcceleratorListingsListPage {
      ...
      load: function (loadOptions) {
        ...
        return that.apiUtility.UtilityProvider_GetPeriodDates(that.SearchPeriod).then(
          (result: any) => {
            ...
            //filter the data
            return that.apiProvider.AcceleratorListings_Search(pageSize, pageNumber, orderField, orderDirection,
              ...
              (result: any) => {
                ...
                return {
                  data: result.AcceleratorListings,
  ...
  exportToExcel() {
    ...
    this.apiProvider.AcceleratorListings_Export(this.OrderField, this.OrderDirection, this.SearchText, this.SearchDateFrom, this.SearchDateTo).then(
      (result: any) => {
  ...
  EditAcceleratorListings() {
    this.routeControl.navigate(["acceleratorlistings-item", { "ref": this.ActionRow.AcceleratorId }]);
  }
