...
@Component({
    selector: 'acceleratortransactions-list.page',
    templateUrl: './acceleratortransactions-list.page.html',
    styleUrls: ['./../../../theme/datagrid-toolbar.css']
})

export class AcceleratorTransactionsListPage{
    ...
    constructor(private routeControl: Router, private apiProvider: APITransactionsProvider, private apiUtility: APIUtilityProvider) {
        appGlobals.SetActivePageTitle("Accelerator Tool Transactions");
    ...
    ngAfterContentInit() {
        ...
        this.dataStore = new DataSource({
            load: function (loadOptions) {
                ...
                return that.apiProvider.AcceleratorToolTransactions_List(pageSize, pageNumber, orderField, orderDirection,
                    ...
                    (result: any) => {
                        ...
                        return {
                            data: result.AcceleratorToolList,
                            totalCount: result.NumberOfRecords,
                            summary: [result.SchooldaysValueTotal, result.EduTimePointsTotal, result.AvgPricePerSchooldayTotal, result.BeneficiaryCountTotal]
                        };
                    },
                    (error) => {
    ...
    exportToExcel() {
        ...
        this.apiProvider.AcceleratorToolTransactions_Export(this.OrderField, this.OrderDirection,
