...
@Component({
    selector: 'generositytransactions-list.page',
    templateUrl: './generositytransactions-list.page.html',
    styleUrls: ['./../../../theme/datagrid-toolbar.css']
})

export class GenerosityTransactionsListPage {
    ...
    constructor(private routeControl: Router, private apiProvider: APITransactionsProvider, private apiUtility: APIUtilityProvider) {
        appGlobals.SetActivePageTitle("Generosity Tool Transactions");
    ...
    ngAfterContentInit() {
        ...
        this.dataStore = new DataSource({
            load: function (loadOptions) {
                ...
                return that.apiProvider.GenerosityToolTransactions_List(pageSize, pageNumber, orderField, orderDirection,
                    ...
                    (result: any) => {
                        ...
                        return {
                            data: result.GenerosityToolList,
    ...
    exportToExcel() {
        ...
        this.apiProvider.GenerosityToolTransactions_Export(this.OrderField, this.OrderDirection,
