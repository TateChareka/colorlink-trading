...
{
    public partial class NewDeliveryNote : Form
    {
        public NewDeliveryNote()
        {
            InitializeComponent();
        }
        private CustomerListResultModel customers;
        private ProductListResultModel products;
        private void NewDeliveryNote_Load(object sender, EventArgs e)
        {
